...
class ACOR:
    def __init__(self, obj_function, search_space, n_ants = 10,new_ants = 2, n_cycles = 200, n_local_cycles = 5, q = 0.5, elite_count = 1, elite_weight = 0.4, evaporation_rate = 0.7, sigma = 0.5):
